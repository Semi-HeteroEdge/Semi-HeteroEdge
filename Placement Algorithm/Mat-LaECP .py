...
def oneLatency(uplatency,bandwidth,microSubvolum,totalcount,microComputDemand,deviceCoputeTotal):
    ...
    compute = microComputDemand / deviceCoputeTotal
    total = comm + compute
...
def threeLatency(uplatency,bandwidth,microSubvolum,totalcount,microComputDemand,deviceCoputeTotal):
    ...
    compute3 = microComputDemand / deviceCoputeTotal
...
# print(dataPD)
# dataPD.to_csv('./result/infoForeachPlace/queue-forest-'+str(thisTotalCount)+'.csv')
#
# waferDevice=[]
# faultDevice=[]
# for micro in thisServices:
...
#
# sourcelossofilename = './result/allplacement/' + str(thisTotalCount) +"-queue--forest--allPlacement.csv"
# features1=["placement"]
